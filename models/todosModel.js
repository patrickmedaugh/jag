...
const destroy = async id => await model.deleteOne({ _id: id }).catch(e => console.log(e));
const update = async (id, updates) => await model.updateOne({ _id: id }, updates).catch(e => console.log(e));
